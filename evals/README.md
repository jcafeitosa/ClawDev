...
Eval framework for testing ClawDev agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the ClawDev heartbeat skill:
