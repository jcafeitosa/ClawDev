...
name: release
description: >
  Coordinate a full ClawDev release across engineering verification, npm,
...
Run the full ClawDev maintainer release workflow, not just an npm publish.
...
7. If running through ClawDev, you have issue context for status updates and follow-up task creation.
...
ClawDev now uses a commit-driven release model:
...
npm view clawdev@canary version
```
...
- release summary in ClawDev issue context
