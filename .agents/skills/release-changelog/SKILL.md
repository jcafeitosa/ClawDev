...
description: >
  Generate the stable ClawDev release changelog at releases/vYYYY.MDD.P.md by
  reading commits, changesets, and merged PR context since the last stable tag.
---

# Release Changelog Skill

Generate the user-facing changelog for the **stable** ClawDev release.

## Versioning Model

ClawDev uses **calendar versioning (calver)**:
...
```
- **Feature name** — Description. ([#123](https://github.com/jcafeitosa/ClawDev/pull/123), @contributor1, @contributor2)
```
