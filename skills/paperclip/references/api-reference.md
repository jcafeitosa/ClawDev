# ClawDev API Reference

Detailed reference for the ClawDev control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "ClawDev Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "clawdev-mobile",
    "cwd": "/Users/me/clawdev-mobile",
    "repoUrl": "https://github.com/acme/clawdev-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `clawdev-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
