...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@clawdev/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@clawdev/adapter-utils").TranscriptEntry[];
