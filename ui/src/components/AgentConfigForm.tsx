...
import { AGENT_ADAPTER_TYPES } from "@clawdev/shared";
import type {
  Agent,
...
// Canonical type lives in @clawdev/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@clawdev/adapter-utils";
import type { CreateConfigValues } from "@clawdev/adapter-utils";
  ...
  return (
    <div className="space-y-1.5">
      ...
      <p className="text-[11px] text-muted-foreground/60">
        CLAWDEV_* variables are injected automatically at runtime.
      </p>
    </div>
  );
}
