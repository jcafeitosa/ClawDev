...
import type { ClawDevPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@clawdev/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: ClawDevPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@clawdev/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
