 ...
 *
 * These components are exported from `@clawdev/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@clawdev/plugin-sdk/ui`
 */
...
function createSdkUiComponent<TProps>(name: string): React.ComponentType<TProps> {
  return function ClawDevSdkUiComponent(props: TProps) {
