/**
 * `@clawdev/plugin-sdk/ui` — Paperclip plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@clawdev/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@clawdev/plugin-sdk/ui";
 *
