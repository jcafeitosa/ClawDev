import type { PluginLauncherRegistration } from "@clawdev/plugin-sdk";

export const PLUGIN_ID = "clawdev-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".clawdev-kitchen-sink-demo.txt",
} as const;
