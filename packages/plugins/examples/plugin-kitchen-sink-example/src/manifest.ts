...
const manifest: ClawDevPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current ClawDev plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "ClawDev",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the ClawDev domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
