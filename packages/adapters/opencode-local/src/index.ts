...
- dangerouslySkipPermissions (boolean, optional): inject a runtime OpenCode config that allows \`external_directory\` access without interactive prompts; defaults to true for unattended ClawDev runs
...
- When \`dangerouslySkipPermissions\` is enabled, ClawDev injects a temporary \
