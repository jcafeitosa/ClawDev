-- 006: Summary continuous aggregates for cost and activity data.
--
-- These complement the granular aggregates in 005 with higher-level
-- summary views used for monthly billing and activity dashboards.
