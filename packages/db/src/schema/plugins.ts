...
import type { PluginCategory, PluginStatus, ClawDevPluginManifestV1 } from "@clawdev/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<ClawDevPluginManifestV1>().notNull(),
