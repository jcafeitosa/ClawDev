...
- `skills/clawdev/SKILL.md` and `skills/clawdev/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.2 `skills/clawdev-create-agent/SKILL.md`
