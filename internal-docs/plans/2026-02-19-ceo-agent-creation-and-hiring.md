...
- installed adapter list for this ClawDev instance
...
## 8. New Skill: `clawdev-create-agent`

Create new skill directory:

- `skills/clawdev-create-agent/SKILL.md`
...
Also update `skills/clawdev/SKILL.md` to reference this skill for hiring workflows.
...
- `clawdev-create-agent` skill + docs updates
