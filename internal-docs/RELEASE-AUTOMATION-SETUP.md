...
This document covers the GitHub and npm setup required for the current ClawDev release model:
...
Do this for every public package that ClawDev publishes.
...
3. add a trusted publisher for the GitHub repository `jcafeitosa/ClawDev`
...
2. revoke any personal automation token that used to publish ClawDev
