...
This is intentionally separate from the normal ClawDev dev image.
...
```sh
review-checkout-pr jcafeitosa/ClawDev 432
cd /work/checkouts/clawdev-clawdev/pr-432
```
...
## Preview the ClawDev app from the PR
...
- ClawDev's embedded PostgreSQL and local storage stay inside the container home volume via `CLAWDEV_HOME=/home/reviewer/.clawdev-review`.
