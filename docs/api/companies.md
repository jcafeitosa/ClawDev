...
Manage companies within your ClawDev instance.
...
Company logo uploads use the normal ClawDev attachment size limit.
...
| `logoUrl` | string | Optional ClawDev asset content path for the stored logo image |
