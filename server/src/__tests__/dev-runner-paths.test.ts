...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local ClawDev state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".clawdev/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/clawdev",
      ),
    ).toBe(false);
