...
type PluginUiSlotDeclaration = NonNullable<NonNullable<ClawDevPluginManifestV1["ui"]>["slots"]>[number];
/** Launcher declaration extracted from plugin manifest */
type PluginLauncherDeclaration = NonNullable<ClawDevPluginManifestV1["launchers"]>[number];
...
interface PluginInstallRequest {
  /** npm package name (e.g., @clawdev/plugin-linear) or local path */
  packageName: string;
...
export function pluginRoutes(
   ...
   *   {
   *     "pluginId": "plg_123",
   *     "pluginKey": "clawdev.claude-usage",
