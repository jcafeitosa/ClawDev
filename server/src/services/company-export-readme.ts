 ...
 */
import type { CompanyPortabilityManifest } from "@clawdev/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [ClawDev](https://clawdev.ing)");
  lines.push("");
