/**
 * PluginEventBus — typed in-process event bus for the ClawDev plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@clawdev/shared";
import type { PluginEvent, EventFilter } from "@clawdev/plugin-sdk";
