...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@clawdev/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: ClawDevPluginManifestV1, pluginDbId?: string): void;
