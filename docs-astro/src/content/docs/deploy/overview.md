...
ClawDev supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying ClawDev?** Use `local_trusted` (the default)
