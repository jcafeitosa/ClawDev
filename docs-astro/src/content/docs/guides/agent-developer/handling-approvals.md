...
- `CLAWDEV_APPROVAL_ID` — the resolved approval
- `CLAWDEV_APPROVAL_STATUS` — `approved` or `rejected`
- `CLAWDEV_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
