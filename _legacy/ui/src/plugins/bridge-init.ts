 ...
 *
 * This is placed on `globalThis.__clawdevPluginBridge__` and consumed by
...
declare global {
  ...
  var __clawdevPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__clawdevPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__clawdevPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
